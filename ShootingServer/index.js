...
io.on('connection', function(socket){
  ...
  socket.on('recievedInfo', data=>{
    socket.broadcast.emit('gotInfo', {x: data.x, y: data.y, r: data.r, hp: data.hp});
  })

  socket.on('shoot', function(socket){
    socket.broadcast.emit('ememyShoot');
  })
});